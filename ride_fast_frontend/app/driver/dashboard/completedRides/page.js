...
const pages = () => {
  ...
  }, [auth.token, dispatch, router, ride.status]); // Added auth.token, dispatch, router to dependency array
      ...
      <div className="px-10">
        <div className="bg-white w-full px-5 py-5 rounded-md shadow-lg my-10">
          ...
          {ride.completedRides.length === 0 ? (
            ...
            ride.completedRides.map((item) => ( // Removed type annotation : RideState
              <div
