                ...
                >
                  <div className="">
                    <h1 className="font-semibold">
                      Driver Id: <span className="font-normal">{driver.id}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Name: <span className="font-normal">{driver.name}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Email: <span className="font-normal">{driver.email}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Mobile: <span className="font-normal">{driver.mobile}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Earning: <span className="font-normal">&#8377; {driver.totalRevenue}</span>
                    </h1>
                  </div>
                  <div className="">
                    <h1 className="font-semibold">
                      License No: <span className="font-normal">{driver.license.licenseNumber}</span>
                    </h1>
                    <h1 className="font-semibold">
                      State: <span className="font-normal">{driver.license.licenseState}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Expiration Date: <span className="font-normal">{driver.license.licenseExpirationDate}</span>
                    </h1>
                  </div>
                  <div className="">
                    <h1 className="font-semibold">
                      Vehicle No: <span className="font-normal">{driver.vehicle.licensePlate}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Company: <span className="font-normal">{driver.vehicle.company}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Model: <span className="font-normal">{driver.vehicle.model}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Year: <span className="font-normal">{driver.vehicle.year}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Color: <span className="font-normal">{driver.vehicle.color}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Capacity: <span className="font-normal">{driver.vehicle.capacity}</span>
                    </h1>
                  </div>
                </div>
              ))
              ...
              rideData.map((ride) => (
                ...
                >
                  <div className="">
                    ...
                    <h1 className="font-semibold">
                      User: <span className="font-normal">{ride.user.email}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Driver: <span className="font-normal">{ride.driver.email}</span>
                    </h1>
                  </div>
                  <div className="">
                    <h1 className="font-semibold">
                      Pickup Area: <span className="font-normal">{ride.pickupArea}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Destination Area: <span className="font-normal">{ride.destinationArea}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Distance Covered: <span className="font-normal">{ride.distance} km</span>
                    </h1>
                    <h1 className="font-semibold">
                      Duration: <span className="font-normal">{convertMillisecondsToMinutesAndHours(ride.duration)}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Fare: <span className="font-normal">&#8377; {ride.fare}</span>
                    </h1>
                  </div>
                  <div className="">
                    <h1 className="font-semibold">
                      Payment Status: <span className="font-normal">{ride.paymentDetails?.paymentStatus}</span>
                    </h1>
                    <h1 className="font-semibold">
                      Payment Id: <span className="font-normal">{ride.paymentDetails?.paymentId}</span>
                    </h1>
